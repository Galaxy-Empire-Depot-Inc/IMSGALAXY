...
namespace DGVPrinterHelper //AllocationRequest
{
    ...
    public class DGVPrinter
    {
        ...
        private void DrawDataGridViewImageCell(Graphics graphics, DataGridViewImageCell imageCell, Rectangle cellBounds)
        {
            if (imageCell.Value is Image image)
            {
                // Stretch the image to fill the cell boundaries
